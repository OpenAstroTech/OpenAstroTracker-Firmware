...
//      Parameters:
//        "nnnnn" is the number of steps from home that the DEC ring can travel upwards, using slewing microsteps
//      Returns:
//        nothing
//
// :XSDLu#
...
//        otherwise to the given parameter.
//      Parameters:
//        "nnnnn" is the number of steps from home that the DEC ring can travel downwards, using slewing microsteps
//      Returns:
//        nothing
//
// :XSDLl#
