...
{
    LOGV2(DEBUG_MEADE, "[LONGITUDE] Format %l for Meade", totalSeconds);
    long secs = labs(totalSeconds);
    ...
    long mins = secs / 60;
    secs      = secs - mins * 60;
    LOGV3(DEBUG_MEADE, "[LONGITUDE] Degs is %l, Mins is %l", degs, mins);
    ...
    LOGV3(DEBUG_MEADE, "[LONGITUDE] Inverted Degs, now %l, Mins is %l", degs, mins);
