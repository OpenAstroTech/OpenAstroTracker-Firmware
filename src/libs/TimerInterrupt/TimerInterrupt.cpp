...
bool TimerInterrupt::setFrequency(float frequency, timer_callback_p callback, uint32_t params, unsigned long duration)
{
    ...
    #if (TIMER_INTERRUPT_DEBUG > 0)
            Serial.println("setFrequency => _toggle_count = " + String(_toggle_count) + ", frequency = " + String(frequency)
    ...
    #if (TIMER_INTERRUPT_DEBUG > 0)
                    Serial.println("OK in loop => _OCR = " + String(_OCRValue) + ", _preScalerIndex = " + String(_prescalerIndex)
                                   + ", preScalerDiv = " + String(prescalerDiv[_prescalerIndex]));
    #endif
    ...
    #if (TIMER_INTERRUPT_DEBUG > 0)
                Serial.println("OK out loop => _OCR = " + String(_OCRValue) + ", _preScalerIndex = " + String(_prescalerIndex)
                               + ", preScalerDiv = " + String(prescalerDiv[_prescalerIndex]));
    #endif
            }
        }
    ...
    #if (TIMER_INTERRUPT_DEBUG > 0)
                    Serial.println("OK in loop => _OCR = " + String(_OCRValue) + ", _preScalerIndex = " + String(_prescalerIndex)
                                   + ", preScalerDiv = " + String(prescalerDivT2[_prescalerIndex]));
    #endif
