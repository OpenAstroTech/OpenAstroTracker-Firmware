...
/////////////////////////////////
  ...
  void Mount::configureRAdriver(Stream *serial, float rsense, byte driveraddress, int rmscurrent, int stallvalue)
  {
    ...
    LOGV2(DEBUG_MOUNT, F("Mount: Requested RA motor rms_current: %d mA"), rmscurrent);
    ...
    LOGV2(DEBUG_MOUNT, F("Mount: Actual RA motor rms_current: %d mA"), _driverRA->rms_current());
    LOGV2(DEBUG_MOUNT, F("Mount: Actual RA CS value: %d"), _driverRA->cs_actual());
    LOGV2(DEBUG_MOUNT, F("Mount: Actual RA vsense: %d"), _driverRA->vsense());
  }
...
/////////////////////////////////
  ...
  void Mount::configureDECdriver(Stream *serial, float rsense, byte driveraddress, int rmscurrent, int stallvalue)
  {
    ...
    LOGV2(DEBUG_MOUNT, F("Mount: Requested DEC motor rms_current: %d mA"), rmscurrent);
    ...
    LOGV2(DEBUG_MOUNT, F("Mount: Actual DEC motor rms_current: %d mA"), _driverDEC->rms_current());
    LOGV2(DEBUG_MOUNT, F("Mount: Actual DEC CS value: %d"), _driverDEC->cs_actual());
    LOGV2(DEBUG_MOUNT, F("Mount: Actual DEC vsense: %d"), _driverDEC->vsense());
  }
#elif SW_SERIAL_UART == 1
...
/////////////////////////////////
  ...
  void Mount::configureAZdriver(Stream *serial, float rsense, byte driveraddress, int rmscurrent, int stallvalue)
  {
    ...
    LOGV2(DEBUG_MOUNT, F("Mount: Requested AZ motor rms_current: %d mA"), rmscurrent);
    ...
    LOGV2(DEBUG_MOUNT, F("Mount: Actual AZ motor rms_current: %d mA"), _driverAZ->rms_current());
    LOGV2(DEBUG_MOUNT, F("Mount: Actual AZ CS value: %d"), _driverAZ->cs_actual());
    LOGV2(DEBUG_MOUNT, F("Mount: Actual AZ vsense: %d"), _driverAZ->vsense());
  }
#elif SW_SERIAL_UART == 1
...
/////////////////////////////////
  ...
  void Mount::configureALTdriver(Stream *serial, float rsense, byte driveraddress, int rmscurrent, int stallvalue)
  {
    ...
    LOGV2(DEBUG_MOUNT, F("Mount: Requested ALT motor rms_current: %d mA"), rmscurrent);
    ...
    LOGV2(DEBUG_MOUNT, F("Mount: Actual ALT motor rms_current: %d mA"), _driverALT->rms_current());
    LOGV2(DEBUG_MOUNT, F("Mount: Actual ALT CS value: %d"), _driverALT->cs_actual());
    LOGV2(DEBUG_MOUNT, F("Mount: Actual ALT vsense: %d"), _driverALT->vsense());
  }
#elif SW_SERIAL_UART == 1
