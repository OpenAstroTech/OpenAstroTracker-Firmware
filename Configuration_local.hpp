...
#define RA_STEPPER_SPEED          1200   // Max. Speed = 600 for 28BYJ-48 and 3000 for NEMA17. Defaults = 400 for 28BYJ-48 and 1200 for NEMA17
#define RA_STEPPER_ACCELERATION   6000   // Defaults: 600 for 28BYJ-48, 6000 for NEMA17
#define DEC_STEPPER_SPEED          1300   // Max. Speed = 600 for 28BYJ-48 and 3000 for NEMA17. Defaults = 600 for 28BYJ-48 and 1300 for NEMA17
#define DEC_STEPPER_ACCELERATION   6000   // Defaults: 600 for 28BYJ-48, 6000 for NEMA17

// TMC2209 UART settings
// These settings work only with TMC2209 in UART connection (single wire to TX)
#define RA_MOTOR_CURRENT_RATING 900       // Current rating of RA motor in mA
#define RA_OPERATING_CURRENT_SETTING 90  // RA operating setting as a percentage of motor rating
#define DEC_MOTOR_CURRENT_RATING 900      // Current rating of DEC motor in mA
#define DEC_OPERATING_CURRENT_SETTING 90  // DEC operating setting as a percentage of motor rating
