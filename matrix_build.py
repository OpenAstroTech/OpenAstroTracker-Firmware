...
BUILD_FLAGS = {
    ...
    "USE_HALL_SENSOR_RA_AUTOHOME": BOOLEAN_VALUES,
    "USE_HALL_SENSOR_DEC_AUTOHOME": BOOLEAN_VALUES,
    "USE_RA_END_SWITCH": BOOLEAN_VALUES,
    "USE_DEC_END_SWITCH": BOOLEAN_VALUES,
