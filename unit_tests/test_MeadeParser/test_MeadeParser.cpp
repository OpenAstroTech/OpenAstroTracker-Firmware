...
#include "../../src/core/MeadeParser.cpp"

using oat::core::MeadeCommandDispatchTarget;
using oat::core::MeadeCommandKind;
using oat::core::MeadeExtraCommandKind;
using oat::core::MeadeExtraLeafCommandKind;
using oat::core::MeadeExtraLeafParseResult;
using oat::core::MeadeExtraParseResult;
using oat::core::MeadeFocusCommandKind;
using oat::core::MeadeFocusParseResult;
using oat::core::MeadeGetCommandKind;
using oat::core::MeadeGetParseResult;
using oat::core::MeadeGpsCommandKind;
using oat::core::MeadeGpsParseResult;
using oat::core::MeadeHomeCommandKind;
using oat::core::MeadeHomeParseResult;
using oat::core::MeadeMovementCommandKind;
using oat::core::MeadeMovementParseResult;
using oat::core::MeadeParseResult;
using oat::core::MeadeQuitCommandKind;
using oat::core::MeadeQuitParseResult;
using oat::core::MeadeSetCommandKind;
using oat::core::MeadeSetParseResult;
using oat::core::MeadeSlewRateCommandKind;
using oat::core::MeadeSlewRateParseResult;
using oat::core::MeadeSyncCommandKind;
using oat::core::MeadeSyncParseResult;
using oat::core::parseMeadeCommand;
using oat::core::parseMeadeExtraCommand;
using oat::core::parseMeadeExtraLeafCommand;
using oat::core::parseMeadeFocusCommand;
using oat::core::parseMeadeGetCommand;
using oat::core::parseMeadeGpsCommand;
using oat::core::parseMeadeHomeCommand;
using oat::core::parseMeadeMovementCommand;
using oat::core::parseMeadeQuitCommand;
using oat::core::parseMeadeSetCommand;
using oat::core::parseMeadeSlewRateCommand;
using oat::core::parseMeadeSyncCommand;
